...
export default async function TermsPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            <h1 className="text-3xl font-bold mb-8 text-charcoal-900">เงื่อนไขการให้บริการ (Terms of Service)</h1>
            ...
            {termsContent ? (
                ...
                <div className="prose prose-slate max-w-none text-gray-600 space-y-6">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-charcoal-800 mb-3">1. ข้อมูลทั่วไป</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-charcoal-800 mb-3">2. สินค้าและบริการ</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-charcoal-800 mb-3">3. ราคาและการชำระเงิน</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-charcoal-800 mb-3">4. การจัดส่งสินค้า</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-charcoal-800 mb-3">5. การคืนสินค้าและการรับประกัน</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-charcoal-800 mb-3">6. กฎหมายที่ใช้บังคับ</h2>
                        <p>
